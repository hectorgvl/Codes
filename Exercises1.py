...
#%%
def areatriangle(base,haltura):
    area=.5*base*haltura
    print "The area of base", base, "and height", haltura, "is", area
...
def celsius_to_fahrenheit(temp):
    nuevaTemp= (9/5)*temp+32
    print "The Celsius temperature",temp,"is equivalent to",nuevaTemp,"degrees Celsius"
...
"""
def name2():
    """Input first and last name, combine the origin of the person just to 
    practice the input command"""
